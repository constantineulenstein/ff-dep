...
export default function TagsFeedFilter() {
  return (
    <div className="TagsFeedFilterSection">
      <SymbolTag image_path="/ff-dep/assets/icons/watermelon.svg" />
      <SymbolTag image_path="/ff-dep/assets/icons/house.svg" />
      <SymbolTag image_path="/ff-dep/assets/icons/list.svg" />
      <Tags children="hiii" />
